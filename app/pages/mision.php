...
<?php include '../../app/pages/includes/header.php'; ?>
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span><a href="aboutUs.php" class="current">Nosotrso</span>
      </div>
    </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <img src="../../public/assets/images/course_4.jpg" alt="Image" class="img-fluid"> 
                </div>
                <div class="col-lg-5 ml-auto align-self-center">
                    <h2 class="section-title-underline mb-5">
                        <span>Nuestra Misión en Educación</span>
                    </h2>
            ...
            <div class="row">
                    <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                        <img src="../../public/assets/images/course_5.jpg" alt="Image" class="img-fluid"> 
                    </div>
                    <div class="col-lg-5 mr-auto align-self-center order-2 order-lg-1">
                        <h2 class="section-title-underline mb-5">
                            <span>Nuestra Visión en Educación</span>
                        </h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. At itaque dolore libero corrupti! Itaque, delectus?</p>
                        <p>Modi sit dolor repellat esse! Sed necessitatibus itaque libero odit placeat nesciunt, voluptatum totam facere.</p>
                    </div>
...
<!--Our vision End here -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
            ...
            <img src="../../public/assets/images/person_1.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
            <div class="feature-1 border person text-center">
            <img src="../../public/assets/images/person_2.jpg" alt="Image" class="img-fluid">
              <div class="feature-1-content">
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
            <div class="feature-1 border person text-center">
            <img src="../../public/assets/images/person_3.jpg" alt="Image" class="img-fluid">
              <div class="feature-1-content">
                <h2>Jonas Tabble</h2>
                <span class="position mb-3 d-block">Math Teacher</span>    
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
          ...
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-5">
            ...
            <div class="feature-1 border person text-center">
                <img src="../../public/assets/images/person_4.jpg" alt="Image" class="img-fluid">
              <div class="feature-1-content">
                <h2>Craig Daniel</h2>
                <span class="position mb-3 d-block">Math Teacher</span>    
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit morbi hendrerit elit</p>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url('../../public/assets/images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
            <h2>¡Suscríbete a nosotros!</h2>
            <p>Cada vez estamos más cerca de ti</p>
          </div>
          <div class="col-lg-5">
