<?php include '../../app/pages/includes/header.php'; ?>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Acerca</h2>
              <p>Ingresa en nuestro sistema de Intranet para encontrar informaciones sobre la comunidad educativa</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Acerca de Nosostros</span>
      </div>
    </div>
