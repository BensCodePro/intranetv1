...
<?php include '../../app/pages/includes/header.php'; ?>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../../public/assets/images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0">Información de nuestra Intranet</h2>
              <p>June 6, 2024 by Admin</p>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="custom-breadcrumns border-bottom">
      <div class="container">
        ...
        <span class="current">Liceos</span>
      </div>
    </div>
    ...
    <div class="section-bg style-1" style="background-image: url('../../public/assets/images/hero_1.jpg');">
        <div class="container">
          <div class="row">
